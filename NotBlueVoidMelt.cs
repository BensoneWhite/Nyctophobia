...
public class NotBlueVoidMelt
{
    public static void Apply()
    {
        On.MeltLights.ApplyPalette += NotNoMeltLights_ApplyPalette;
        On.MeltLights.Update += NotMeltLights_Update;
        On.MeltLights.MeltLight.Update += NotMeltLight_Update;
    }

    private static void NotMeltLight_Update(On.MeltLights.MeltLight.orig_Update orig, MeltLights.MeltLight self, bool eu)
    {
    ...
    private static void NotMeltLights_Update(On.MeltLights.orig_Update orig, MeltLights self, bool eu)
    {
        var room = self.room;
    ...
    private static void NotNoMeltLights_ApplyPalette(On.MeltLights.orig_ApplyPalette orig, MeltLights self, RoomCamera.SpriteLeaser sLeaser, RoomCamera rCam, RoomPalette palette)
    {
        if (ModManager.MSC && self.room.world.region != null && self.room.world.region.name == "MO") 
