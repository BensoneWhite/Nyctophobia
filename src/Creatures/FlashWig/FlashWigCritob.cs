...
public class FlashWigCritob : Critob
{
    ...
    {
        Icon = IsPrideDay
            ? new SimpleIcon("Kill_DropBug", new Color(Random.value, Random.value, Random.value))
            : new SimpleIcon("Kill_DropBug", Color.cyan);
    ...
    {
        return IsPrideDay ? new Color(Random.value, Random.value, Random.value) : Color.cyan;
    }
