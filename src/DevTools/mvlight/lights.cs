...
public class Light : VoidSeaScene.VoidSeaSceneElement
{
    public class Arm
    {
        public Light owner;
        ...
        public Arm(Light owner, int firstSprite, float totalLength, float side, int index, bool hasThread)
        {
    ...
    public class Scales
    {
        ...
        public Scales(Light owner, int firstSprite, int index)
        {
            this.firstSprite = firstSprite;
            this.owner = owner;
            this.index = index;
    ...
    public Light(VoidSeaScene voidSea, Vector2 pos, float depth, bool mainWorm)
    ...
    public override void InitiateSprites(SpriteLeaser sLeaser, RoomCamera rCam)
    {
        ...
        sLeaser.sprites[BodySprite].shader = rCam.game.rainWorld.Shaders["LightBody"];
        for (int i = 0; i < fins.Length; i++)
        {
            for (int j = 0; j < 2; j++)
            {
                ...
                sLeaser.sprites[FinSprite(i, j)].shader = rCam.game.rainWorld.Shaders["LightFin"];
