...
public class CacaoFruitData(PlacedObject owner) : Pom.Pom.ManagedData(owner, [new Pom.Pom.ExtEnumField<CacaoFruitType>(nameof(Type), CacaoFruitType.CacaoFruit, displayName: nameof(Type))])
{
